...
namespace NbaStore.App.Infrastructure.Helpers
{
    public static class FormGroupHelper
    {
            ...
            Expression<Func<TModel,TResult>> expression)
        {
            ...
            {
                var label = htmlHelper.LabelFor(expression, new
                {
                    @class = "control-label col-sm-2"
                });
                var editor = htmlHelper.EditorFor(expression, new
                {
                    htmlAttributes = new
                    {
                        @class = "form-control"
                ...
                var validationMessage = htmlHelper.ValidationMessageFor(expression, null, new
                {
                    @class = "text-danger"
                });
